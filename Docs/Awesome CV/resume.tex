...
\address{Brusilovsky str. 159, 050000 Almaty, Kazakhstan}
\mobile{+7 (707)-463-2528} 
%%% Social
\email{yernurb@gmail.com}
%%% Optionals
\position{Physicist{\enskip\cdotp\enskip}Physics Teacher}
...
\makecvfooter
  {\today}
  {Yernur Baibolatov~~~·~~~Curriculum Vitae}
  {\thepage}
